    ...
    <div class="nav">
        <ul>
            ...
            if ($_SESSION["L_ID"] !== "" && $_SESSION["L_NAME"] !== "" && $_SESSION["L_STATUS"] == 1) {
                ...
                <li class="log_time_choose_project"><a id="log_time_choose_project"
                                                       href="index.php?page=log_time_choose_project">Log Tijd</a></li>
                <li class="explore"><a id="explore" href="index.php?page=explore">Projecten & Taken</a></li>
                <li class="wachtwoord_wijzigen"><a id="wachtwoord_wijzigen" href="index.php?page=wachtwoord_wijzigen">Wachtwoord
                        Wijzigen</a></li>
