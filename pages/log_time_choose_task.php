<div class="form">
    ...
    if ($_SESSION['L_STATUS'] == 1) {
        ...
        <select id='input' name='taak' onchange='setTextField(this)' style='text-align-last:center;' required>
        ...
        <input type='text' id='input' onfocus=(this.type='number') name='uren' placeholder='uren' max='24' step='.25' min='.25' placeholder='Uren...' required>
        <textarea id='input' name='opmerking' rows='4' cols='50' maxlength='255' placeholder='Opmerking...' required></textarea>
