            ...
            <div class="field">
                ...
                <p>Voer
                    <?php if (!isset($user_ID)) {
                        echo("uw E-mail adres in en");
                    } ?> een nieuw wachtwoord in en herhaal deze om je wachtwoord opnieuw in te stellen.</p>

                <span><?php if (isset($errors['email'])) echo $errors['email'] ?></span>
                <input id="input" type="email" name="email" placeholder="E-Mail Adres"
